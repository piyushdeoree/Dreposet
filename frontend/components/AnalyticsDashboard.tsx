...
export default function AnalyticsDashboard({ analytics }: { analytics: Analytics }) {
  ...
  return (
  <div className="mb-8 bg-[#0a0f2c] rounded-2xl p-6 shadow-lg">
    <h2 className="text-lg font-bold mb-4 text-white">Search Analytics Dashboard</h2>
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
      ...
      <SummaryCard label="Avg Similarity" value={`${Math.round(analytics.average_similarity * 100)}%`} />
      <SummaryCard label="Sources" value={analytics.sources_searched.join(", ")} />
    </div>
